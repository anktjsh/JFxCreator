...
public class TagHighlighter {
    ...
    public void apply() {
        ...
        if (editor.getTabPane() != null) {
            String form = JFxCreator.class.getResource("xml-highlighting.css").toExternalForm();
            ...
            editor.tabPaneProperty().addListener((ob, older, newer) -> {
                if (newer != null) {
                    newer.getStylesheets().add(JFxCreator.class.getResource("xml-highlighting.css").toExternalForm());
                }
            });
        }
    }
